...
import math
from iebot.utils import get_position_mask_bitmap, transform_play_to_column, translate_board
from iebot.utils_cy import connected_four, generate_plays
...
def iebot_v6(obs, config):
    ...
    play = manager(current_node=node, max_time=6)
