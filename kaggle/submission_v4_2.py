...
class Node:
    ...
    def create_children(self, columns_map):
        ...
        n_items = len(plays)
        if n_items == 7:
            plays = [plays[3], plays[4], plays[2], plays[1], plays[5], plays[6], plays[0]]
        elif n_items == 6:
            plays = [plays[2], plays[3], plays[1], plays[4], plays[0], plays[5]]
        elif n_items == 5:
            plays = [plays[2], plays[1], plays[3], plays[4], plays[0]]
        elif n_items == 4:
            plays = [plays[1], plays[2], plays[0], plays[1]]
